...
int main(int argc, char **argv) {
       ...
       cout << "  ******************************************* " << "\n";
       cout << "  *                                         * " << "\n";
       cout << "  *      HELLO  -- You are Running  GRUsort * " << "\n";
	...
	if (argc <= 2) {
		cout
				<< " GRUsort : merges and sorts events with timestamps order from differents files.\n";
		cout
				<< " Usage   : GRUsort filename1 filemane2 [filename3] [filename4] etc.....\n";
		cout
				<< " Example : GRUsort  /data/e656X/e656/acquisition/run_12/run_0077.dat.07Oct13_05h58m49s\n";
		cout
				<< "           /data/e656X/e656/acquisition/run_13/run_0077.dat.07Oct13_05h58m49s /data/e656X/e656/acquisition/run_14/run_0077.dat.07Oct13_05h58m49s\n";
			...
			if (runfinished[i] != true) {
				if (timestamp[i] == 0)
					cout << "\nWarning timestamp = 0 for banche " << i
							<< " General Event counter : " << fEventCounter<< "  Branch Event counter : "<< NbEventsIn[i]
							<< "\n";
