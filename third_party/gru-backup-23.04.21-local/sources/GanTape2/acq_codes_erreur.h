...
#define ACQ_VISUNOCONNECT  0x080180FB
 /* <the visualisation is not currently connected to host> */
...
#define ACQ_DISEVTDUMP  0x080181EB
 /* <interactiv dump of events is disabled> */
#define ACQ_ENABEVTDUMP  0x080181F3
 /* <interactiv dump of events is currently enabled> */
#define ACQ_DISTAPCONF  0x080181FB
 /* <usage of tape configuration disabled. Use only one device> */
#define ACQ_ENABTAPCONF  0x08018203
 /* <usage of tape configuration is currently enabled> */
#define ACQ_TAPCONFNOTDEF  0x0801820B
 /* <tape configuration is enabled, but not defined; use TAPE DEFINE> */
#define ACQ_TIMESTAMP  0x08018213
 /* <just used for time information...> */
...
#define ACQ_NOTALLOC  0x080189C0
 /* <this storage device is not currently yours> */
...
#define ACQ_TAPEINUSE  0x080189E8
 /* <this storage device is currently used by your acquisition> */
#define ACQ_TAPENODISP  0x080189F0
 /* <this storage device is not currently available> */
...
#define ACQ_STORNONEXIST  0x08018AA8
 /* <the spectrum you want save does not currently exist> */
...
#define ACQ_NOINCRSPEC  0x08018AC0
 /* <this spectrum is not currently incremented> */
...
#define ACQ_NOCTRLBUFDISP  0x08018B48
 /* <there is currently no control (CTRL, SCALE or JBUS) buffer because acq is stop */
#define ACQ_ERRCTRLBUF  0x08018B50
 /* <error occurs in control(CTRL, SCALE or JBUS) buffer copy (twice changed)> */
#define ACQ_NOCURRCTRLBUF  0x08018B58
 /* <there is no available CTRL (SCALE or JBUS) buffer, please try again> */
...
#define ACQ_TOOMANYDEV  0x08018D62
 /* <too many devices in tape configuration definition; no change done> */
#define ACQ_CONFNOTALL  0x08018D6A
 /* <usage of configuration is not allowed for SKIP, INQUIRE and DIRECTORY operations; */
#define ACQ_ERRBUFWRNOW  0x08018D72
 /* <error in buffers management for write no wait on tapes;contact system manager> */
...
#define ACQ_VMELINKERR  0x08019064
 /* <a fatal error was detected in the VME-HOST Data Link...> */
...
#define ACQ_ABORT  0x08019104
 /* <ACQUISITION process is aborting> */
...
#define ACQ_BUFSIZNOTGOO  0x080188D1
 /* <buffer size is not good> */
