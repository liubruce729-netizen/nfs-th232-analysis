...
string MFMXmlDataDescriptionFrame::FillExampleOfText() {
	...
	/// Fill text fied with a example with a description of 16 parameters and 10 scalers.
	string text;
...
text.append("		        <label>131074</label>\n");
text.append("		      <voie>\n");
text.append("		        <nom>TGV_Echelle_2</nom>\n");
text.append("		        <label>131075</label>\n");
text.append("		      </voie>\n");
text.append("		        <nom>TGV_Echelle_3</nom>\n");
text.append("		        <label>131076</label>\n");
text.append("		      <voie>\n");
text.append("		        <nom>TGV_Echelle_4</nom>\n");
text.append("		        <label>131077</label>\n");
text.append("		      </voie>\n");
text.append("		        <nom>TGV_Echelle_5</nom>\n");
text.append("		        <label>131078</label>\n");
text.append("		      <voie>\n");
text.append("		        <nom>TGV_Echelle_6</nom>\n");
text.append("		        <label>131079</label>\n");
text.append("		      </voie>\n");
text.append("		        <nom>TGV_Echelle_7</nom>\n");
text.append("		        <label>131080</label>\n");
text.append("		      <voie>\n");
text.append("		        <nom>TGV_Echelle_8</nom>\n");
text.append("		        <label>131081</label>\n");
text.append("		      </voie>\n");
text.append("		        <nom>TGV_Echelle_9</nom>\n");
text.append("		        <label>131082</label>\n");
text.append("		      </voie>\n");
text.append("		    </module>\n");
text.append("		  </cpu>\n");
text.append("		</scaler_description>\n");
...
text.append("		    <deph> 1\n");
text.append("		      <channel>\n");
text.append("		        <name>CARD_GATCONF </name>\n");
text.append("		        <label>1</label>\n");
text.append("		        <nbits> 15 </nbits>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>Energy1</name>\n");
text.append("		        <label>2</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>Energy2</name>\n");
text.append("		        <label>3</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>Energy3</name>\n");
text.append("		        <label>4</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>Energy4</name>\n");
text.append("		        <label>5</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>Energy5</name>\n");
text.append("		        <label>6</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_1</name>\n");
text.append("		        <label>7</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_2</name>\n");
text.append("		        <label>8</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_3</name>\n");
text.append("		        <label>9</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_4</name>\n");
text.append("		        <label>10</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_5</name>\n");
text.append("		        <label>11</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_6</name>\n");
text.append("		        <label>13</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_7</name>\n");
text.append("		        <label>13</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_8</name>\n");
text.append("		        <label>14</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_9</name>\n");
text.append("		        <label>15</label>\n");
text.append("		      </channel>\n");
text.append("		      <channel>\n");
text.append("		        <name>QDC_10</name>\n");
text.append("		        <label>16</label>\n");
text.append("		      </channel>\n");
text.append("		    </channels>\n");
text.append("		  </parameter_description>\n");
text.append("/<data_description>\n");
...
int  MFMXmlDataDescriptionFrame::InitXml(bool write_or_read, string commentaire) {
	...
	// if write_or_read = true  => write configuration => commentaire is a comment in the header of file if we want to include one
	...
	TiXmlDocument doc;
	doc.Parse((const char*)GetText(), 0, TIXML_ENCODING_UTF8);
/*
	if (write_or_read) {
		fError.Infos( "Init of write XML file");

		tempos="";
		TiXmlDocument TiXmlDocument = new TiXmlDocument(pFilename);
